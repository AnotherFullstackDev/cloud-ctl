module github.com/AnotherFullstackDev/cloud-ctl

go 1.24.2

require (
	github.com/99designs/keyring v1.2.2
	github.com/AnotherFullstackDev/httpreqx v0.0.5
...
require (
	...
	github.com/go-git/go-git/v6 v6.0.0-20251123162143-36fa81975a20 // indirect
